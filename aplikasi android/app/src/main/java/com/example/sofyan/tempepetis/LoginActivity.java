...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private TextInputLayout mWidgetOtp;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mWidgetOtp = (TextInputLayout) findViewById(R.id.widgetOtp);
        ...
        btnNextOtp.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if (attemptNext()){
                    ...
                    mWidgetOtp.setVisibility(View.GONE);
                }
            }
        });
    ...
    private void attemptLogin() {
        ...
        if (cancel) {
            ...
            showProgress(true);
            mAuthTask = new UserLoginTask(otp, email, password);
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        UserLoginTask(String otp, String email, String password) {
            mEmail = email;
            mPassword = password;
            mOtp = otp;
        }
